  ...
  return (
    <div className='horizontal-card-project'>
        <div className='scroll-container' >
            ...
            <div className=' md:grid md:grid-cols grid-cols-[repeat(auto-fit,minmax(300px,320px))] justify-between md:gap-6 overflow-x-scroll scrollbar-none transition-all'>
                ...
                <button className='p-0.5 text-sm hidden md:block absolute right-0'onClick={scrollRight}><AnimatedButton direction="right"/></button>*/}
                    {
                        data.map((product,index) =>{
                            return(
                                <Link to={"/product/"+product?._id} className='w-full min-w-[280px]  md:min-w-[320px] max-w-[280px] md:max-w-[320px]  bg-white rounded-sm shadow scrollbar-none ' onClick={scrollTop}>
